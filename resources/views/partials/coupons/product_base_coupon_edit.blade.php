<div class="card-header mb-2">
    <h5 class="section-title mb-0">{{translate('Add Your Product Base Coupon')}}</h5>
</div>
...
<div class="product-choose-list">
    <div class="product-choose">
        <div class="form-group row">
            ...
            <div class="col-lg-9">
                <select name="product_ids[]" class="form-control product_id plx-selectpicker" data-live-search="true" data-selected-text-format="count" required multiple>
...
<div class="form-group row">
    ...
    <div class="col-sm-9">
      <input type="text" class="form-control plx-date-range" value="{{ $start_date .' - '. $end_date }}" name="date_range" placeholder="Select Date">
    </div>
</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $('.plx-date-range').daterangepicker();
