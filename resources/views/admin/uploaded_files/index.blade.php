...
<div class="plx-titlebar text-left mt-2">
	<div class="row align-items-center">
		<div class="col-md-6">
			<h1 class="h3">{{translate('uploaded files')}}</h1>
		</div>
...
<div class="card">
    <form id="sort_uploads" action="">
        <div class="card-header row gutters-5">
            <div class="col-md-3">
                <h5 class="section-title mb-0">{{translate('All files')}}</h5>
            </div>
    ...
    <div class="modal-dialog modal-sm modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="section-title fw-600">{{ translate('Delete Confirmation') }}</h4>
...
@section('script')
	<script type="text/javascript">
		function detailsInfo(e){
			...
			$.post('{{ route('uploaded-files.info') }}', {_token: PLX.data.csrf, id:id}, function(data){
