    ...
    <div class="card-body">
        <div class="row gutters-5">
            ...
            @if (addon_is_activated('delivery_boy'))
                <div class="col-md-3 ml-auto">
                    ...
                    <select class="form-control plx-selectpicker" data-live-search="true" data-minimum-results-for-search="Infinity" id="assign_deliver_boy">
            ...
            <div class="col-md-3 ml-auto">
                ...
                <select class="form-control plx-selectpicker"  data-minimum-results-for-search="Infinity" id="update_payment_status">
            ...
            <div class="col-md-3 ml-auto">
                ...
                @if($delivery_status != 'delivered' && $delivery_status != 'cancelled')
                    <select class="form-control plx-selectpicker"  data-minimum-results-for-search="Infinity" id="update_delivery_status">
        ...
        <div class="row gutters-5">
            ...
            <div class="col-md-4 ml-auto">
                <table class="invoice-details table table-bordered plx-table">
                    <tbody>
                        <tr>
        ...
        <div class="">
            <table class="table table-bordered plx-table invoice-summary">
                <thead>
    ...
    <script type="text/javascript">
        $('#assign_deliver_boy').on('change', function(){
            ...
            $.post('{{ route('orders.delivery-boy-assign') }}', {
                ...
                PLX.plugins.notify('success', '{{ translate('Delivery boy has been assigned') }}');
            });
        });
        ...
        $('#update_delivery_status').on('change', function(){
            ...
            $.post('{{ route('orders.update_delivery_status') }}', {_token:'{{ @csrf_token() }}', order_id:order_id, status:status}, function(data){
                PLX.plugins.notify('success', '{{ translate('Delivery status has been updated') }}');
            });
        });
        ...
        $('#update_payment_status').on('change', function(){
            ...
            $.post('{{ route('orders.update_payment_status') }}', {_token:'{{ @csrf_token() }}', order_id:order_id, status:status}, function(data){
                PLX.plugins.notify('success', '{{ translate('Payment status has been updated') }}');
            });
        });
    </script>
@endsection
