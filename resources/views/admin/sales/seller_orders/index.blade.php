...
<div class="card">
    <form class="" action="" method="GET">
        <div class="card-header row gutters-5">
            ...
            <div class="col-lg-2">
                <div class="form-group mb-0">
                    <select class="form-control form-control plx-selectpicker mb-2 mb-md-0" id="seller_id" name="seller_id">
        ...
        <table class="table plx-table mb-0">
            <thead>
                <tr>
                    ...
                    <th width="20%" class="text-nowrap">{{translate('Order Code')}}</th>
                    <th data-breakpoints="lg" class="text-nowrap">{{translate('Num. of Products')}}</th>
                    <th data-breakpoints="lg" class="text-nowrap">{{translate('Customer')}}</th>
                    <th>{{translate('Seller')}}</th>
                    <th data-breakpoints="lg" class="text-nowrap">{{translate('Amount')}}</th>
                    <th data-breakpoints="lg" class="text-nowrap">{{translate('Delivery Status')}}</th>
                    <th data-breakpoints="lg" class="text-nowrap">{{translate('Payment Method')}}</th>
                    <th data-breakpoints="lg" class="text-nowrap">{{translate('Payment Status')}}</th>
            ...
            <tbody>
                @foreach ($orders as $key => $order)
                    <tr>
                        ...
                        <td class="text-right">
                            <a class="btn btn-action-button btn-icon btn-circle btn-sm" href="{{route('seller_orders.show', encrypt($order->id))}}" title="{{ translate('View') }}">
