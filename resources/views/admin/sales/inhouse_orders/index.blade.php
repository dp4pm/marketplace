      ...
      <div class="card-header row gutters-5">
        ...
        <div class="col-lg-2">
          ...
          <div class="col-lg-2 ml-auto">
            <select class="form-control plx-selectpicker" name="payment_type" id="payment_type" onchange="sort_orders()">
          ...
          <div class="col-lg-2 ml-auto">
            <select class="form-control plx-selectpicker" name="delivery_status" id="delivery_status" onchange="sort_orders()">
    ...
    <div class="card-body">
        <table class="table plx-table mb-0">
            <thead>
                <tr>
                    <th>#</th>
                    <th class="text-nowrap">{{translate('Order Code')}}</th>
                    <th data-breakpoints="md" class="text-nowrap">{{translate('Num. of Products')}}</th>
                    <th data-breakpoints="md" class="text-nowrap">{{translate('Customer')}}</th>
                    <th data-breakpoints="md" class="text-nowrap">{{translate('Amount')}}</th>
                    <th data-breakpoints="md" class="text-nowrap">{{translate('Delivery Status')}}</th>
                    <th data-breakpoints="md" class="text-nowrap">{{translate('Payment Method')}}</th>
                    <th data-breakpoints="md" class="text-nowrap">{{translate('Payment Status')}}</th>
            ...
            <tbody>
                @foreach ($orders as $key => $order)
                    <tr>
                        ...
                        <td class="text-right">
                            <a class="btn btn-action-button btn-icon btn-circle btn-sm" href="{{route('inhouse_orders.show', encrypt($order->id))}}" title="{{ translate('View') }}">
