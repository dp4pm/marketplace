...
<div class="card">
    <div class="card-header">
        <h5 class="section-title mb-0">{{translate('Classified Products')}}</h5>
    </div>
    <div class="card-body">
            ...
            <tbody>
                @foreach($products as $key => $product)
                    <tr>
                        ...
                        <td class="text-right">
                            <a class="btn btn-action-button btn-icon btn-circle btn-sm" href="{{route('customer.product', $product->slug)}}" title="{{ translate('Show') }}">
                                <i class="las la-eye"></i>
                            </a>
                            <a href="#" class="btn btn-action-button btn-icon btn-circle btn-sm confirm-delete" data-href="{{route('customer_products.destroy', $product->id)}}}}" title="{{ translate('Delete') }}">
