...
<div class="card">
    <form class="" id="sort_sellers" action="" method="GET">
        <div class="card-header row gutters-5">
            <div class="col">
                <h5 class="section-title mb-0">{{ translate('All Seller') }}</h5>
            </div>
            ...
            <div class="col-md-3 ml-auto">
                <select class="form-control plx-selectpicker" name="approved_status" id="approved_status" onchange="sort_sellers()">
                            ...
                            <!--<td>{{ ($key+1) + ($sellers->currentPage() - 1)*$sellers->perPage() }}</td>-->
                                ...
                                <td class="text-right">
                                    <div class="dropdown float-right">
                                        <button type="button" class="btn btn-sm btn-circle btn-action-button btn-icon dropdown-toggle no-arrow" data-toggle="dropdown" href="javascript:void(0);" role="button" aria-haspopup="false" aria-expanded="false">
    ...
    <script type="text/javascript">
        ...
        function update_approved(el){
            ...
            $.post('{{ route('sellers.approved') }}', {_token:'{{ csrf_token() }}', id:el.value, status:status}, function(data){
                if(data == 1){
                    PLX.plugins.notify('success', '{{ translate('Approved sellers updated successfully') }}');
                }
                else{
