        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="section-title mb-0">{{translate('Seller Verification Form')}}</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('seller_verification_form.update') }}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                ...
                                <ul class="list-group">
                                    <li class="list-group-item btn text-left mb-3" onclick="appenddToForm('text')" style="background: rgba(0,0,0,0.1)">{{translate('Text Input')}}</li>
                                    <li class="list-group-item btn text-left mb-3" onclick="appenddToForm('select')" style="background: rgba(0,0,0,0.1)">{{translate('Select')}}</li>
                                    <li class="list-group-item btn text-left mb-3" onclick="appenddToForm('multi-select')" style="background: rgba(0,0,0,0.1)">{{translate('Multiple Select')}}</li>
                                    <li class="list-group-item btn text-left mb-3" onclick="appenddToForm('radio')" style="background: rgba(0,0,0,0.1)">{{translate('Radio')}}</li>
                                    <li class="list-group-item btn text-left" onclick="appenddToForm('file')" style="background: rgba(0,0,0,0.1)">{{translate('File')}}</li>
                                </ul>
