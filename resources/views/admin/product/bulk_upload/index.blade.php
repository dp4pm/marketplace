...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="section-title mb-0">{{translate('Product Bulk Upload')}}</h5>
        </div>
        <div class="card-body">
            <div class="alert bg-base" style="color: #004085;border-color: #92278F;margin-bottom:0;margin-top:10px;">
            ...
            <br>
            <div class="">
                <a href="{{ static_asset('download/product_bulk_demo.xlsx') }}" download><button class="btn btn-primary">{{ translate('Download CSV')}}</button></a>
            </div>
            <div class="alert bg-base" style="color: #004085;border-color: #92278F;margin-bottom:0;margin-top:10px;">
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="section-title mb-0"><strong>{{translate('Upload Product File')}}</strong></h5>
        </div>
        <div class="card-body">
