...
<div class="plx-titlebar text-left mt-2 mb-3">
    <h5 class="section-title mb-0">{{translate('Role Information')}}</h5>
</div>
        ...
        <div class="card-body p-0">
            ...
            <form class="p-4" action="{{ route('roles.update', $role->id) }}" method="POST">
                ...
                <div class="form-group row">
                    <label class="col-md-2 col-from-label fs-18" for="name">{{translate('Name')}} <i class="las la-language text-danger" title="{{translate('Translatable')}}"></i></label>
                    <div class="col-md-10">
