...
@section('content')
    <div class="plx-titlebar text-left mt-2">
        <div class="row align-items-center">
            <div class="col">
                <h1 class="h3">{{ translate('Website Appearance') }}</h1>
            </div>
        </div>
    </div>
    <br>
    	...
    	<div class="col-lg-12">
    		<div class="card">
    			<div class="card-header">
    				<h6 class="section-title mb-0">{{ translate('General') }}</h6>
    			</div>
    			<div class="card-body">
    		...
    		<div class="card">
    			<div class="card-header">
    				<h6 class="section-title mb-0">{{ translate('Global SEO') }}</h6>
    			</div>
    			<div class="card-body">
            ...
            <div class="card">
    			<div class="card-header">
    				<h6 class="section-title mb-0">{{ translate('Cookies Agreement') }}</h6>
    			</div>
    			<div class="card-body">
    				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
    					@csrf
    					<div class="form-group row">
                            ...
                            <div class="col-md-8">
        						...
        						<textarea name="cookies_agreement_text" rows="4" class="plx-text-editor form-control" data-buttons='[["font", ["bold"]],["insert", ["link"]]]'>{{ get_setting('cookies_agreement_text') }}</textarea>
                            </div>
    					</div>
                        <div class="form-group row">
            ...
            <div class="card">
    			<div class="card-header">
    				<h6 class="section-title mb-0">{{ translate('Website Popup') }}</h6>
    			</div>
    			<div class="card-body">
    				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
    					@csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                ...
                                <textarea name="website_popup_content" rows="4" class="plx-text-editor form-control" >{{ get_setting('website_popup_content') }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
            ...
            <div class="card">
                <div class="card-header">
                    <h6 class="section-title mb-0">{{ translate('Custom Script') }}</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
