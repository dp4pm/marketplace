...
@section('content')
    ...
    <ul class="nav nav-tabs nav-fill border-light mb-3">
        @foreach (\App\Models\Language::all() as $key => $language)
            <li class="nav-item rounded">
                <a class="rounded nav-link text-reset @if ($language->code == $lang) active @else bg-soft-dark border-light border-left-0 @endif py-3" href="{{ route('website.footer', ['lang'=> $language->code] ) }}">
    ...
    <div class="card">
    	<div class="card-header">
    		<h6 class="section-title mb-0">{{ translate('Footer Widget') }}</h6>
    	</div>
    	<div class="card-body">
    					...
    					<div class="card-body">
    						<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
    			                ...
    			                <div class="form-group">
    								...
    								<textarea class="plx-text-editor form-control" name="about_us_description" data-buttons='[["font", ["bold", "underline", "italic"]],["para", ["ul", "ol"]],["view", ["undo","redo"]]]' placeholder="Type.." data-min-height="150">
    ...
    <div class="card">
    	<div class="card-header">
    		<h6 class="section-title mb-0">{{ translate('Footer Bottom') }}</h6>
    	</div>
        <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
            @csrf
           <div class="card-body">
                <div class="card shadow-none bg-light">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                  			...
                  			<textarea class="plx-text-editor form-control" name="frontend_copyright_text" data-buttons='[["font", ["bold", "underline", "italic"]],["insert", ["link"]],["view", ["undo","redo"]]]' placeholder="Type.." data-min-height="150">
