	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header">
				<h6 class="section-titleo mb-0">{{ translate('Header Setting') }}</h6>
			</div>
			<div class="card-body">
							...
							@if (get_setting('header_menu_labels') != null)
								@foreach (json_decode( get_setting('header_menu_labels'), true) as $key => $value)
									<div class="row gutters-5">
										...
										<div class="col-auto">
											<button type="button" class="btn btn-icon btn-circle btn-md btn-action-button" data-toggle="remove-parent" data-parent=".row">
