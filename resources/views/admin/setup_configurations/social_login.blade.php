...
<div class="row">
    <div class="col-md-6">
        <div class="card">
            <div class="card-header">
                <h5 class="section-title mb-0">{{translate('Google Login Credential')}}</h5>
            </div>
            <div class="card-body">
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header">
                <h5 class="section-title mb-0">{{translate('Facebook Login Credential')}}</h5>
            </div>
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('env_key_update.update') }}" method="POST">
                    @csrf
...
<div class="row">
    <div class="col-md-6">
        <div class="card">
            <div class="card-header">
                <h5 class="section-title mb-0">{{translate('Twitter Login Credential')}}</h5>
            </div>
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('env_key_update.update') }}" method="POST">
                    @csrf
