            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('business_settings.update') }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <select class="form-control plx-selectpicker" name="system_default_currency" data-live-search="true">
            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('business_settings.update') }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <select class="form-control plx-selectpicker" name="symbol_format">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <select class="form-control plx-selectpicker" name="decimal_separator">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <select class="form-control plx-selectpicker" name="no_of_decimals">
...
<div class="plx-titlebar text-left mt-4 mb-3">
	<div class="row align-items-center">
		<div class="col-md-6">
{{--			<h1 class="h3">{{translate('Currencies')}}</h1>--}}
		</div>
...
<div class="card">
    <div class="card-header row gutters-5">
        <div class="col text-center text-md-left">
            <h5 class="mb-md-0 h6">{{ translate('All Currency') }}</h5>
        </div>
        <div class="col-md-4">
            ...
            <tbody>
                @foreach ($currencies as $key => $currency)
                    <tr>
                        ...
                        <td class="text-right">
                            <a class="btn btn-action-button btn-icon btn-circle btn-sm" onclick="edit_currency_modal('{{$currency->id}}');" title="{{ translate('Edit') }}">
    ...
    <script type="text/javascript">
        ...
        function update_currency_status(el){
            ...
            $.post('{{ route('currency.update_status') }}', {_token:'{{ csrf_token() }}', id:el.value, status:status}, function(data){
                if(data == 1){
                    PLX.plugins.notify('success', '{{ translate('Currency Status updated successfully') }}');
                }
                else{
