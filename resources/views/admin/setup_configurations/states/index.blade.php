                    ...
                    <div class="card-header row gutters-5">
                        ...
                        <div class="col-md-8 d-flex justify-content-end">
                            ...
                            <div class="form-group mb-0 ml-3">
                                <select class="form-control plx-selectpicker w-100" data-live-search="true" id="sort_country" name="sort_country">
                        ...
                        <tbody>
                            @foreach($states as $key => $state)
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a class="btn btn-action-button btn-icon btn-circle btn-sm" href="{{ route('states.edit', $state->id) }}" title="{{ translate('Edit') }}">
    			...
    			<div class="card-body">
    				<form action="{{ route('states.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select class="select2 form-control plx-selectpicker" name="country_id" data-toggle="select2" data-placeholder="Choose ..." data-live-search="true">
                                @foreach (\App\Models\Country::where('status', 1)->get() as $country)
