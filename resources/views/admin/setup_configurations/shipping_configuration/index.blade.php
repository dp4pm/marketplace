...
<div class="row">
    <div class="col-lg-6 mb-3">
        <div class="card h-100">
            <div class="card-header">
                <h5 class="section-title mb-0">{{translate('Select Shipping Method')}}</h5>
            </div>
            <div class="card-body">
    ...
    <div class="col-lg-6 mb-3">
        <div class="card h-100">
            <div class="card-header">
                <h5 class="section-title mb-0">{{translate('Note')}}</h5>
            </div>
            <div class="card-body">
                <ul class="list-group">
...
<div class="row">
    <div class="col-lg-6 mb-3">
        <div class="card h-100">
            <div class="card-header">
                <h5 class="section-title mb-0">{{translate('Shipping Cost for Admin Products')}}</h5>
            </div>
            <form action="{{ route('shipping_configuration.update') }}" method="POST" enctype="multipart/form-data">
              <div class="card-body">
                  @csrf
