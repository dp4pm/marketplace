...
<div class="plx-titlebar text-left mt-2">
    <div class="row align-items-center">
        ...
        <div class="col-md-6 text-md-right">
            <a href="#" data-target="#add-tax" data-toggle="modal" class="btn btn-create">
        ...
        <table class="table plx-table mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right">
                        <a class="btn btn-action-button btn-icon btn-circle btn-sm" href="{{route('tax.edit', $tax->id )}}" title="{{ translate('Edit') }}">
                            <i class="las la-edit"></i>
                        </a>
                        <a href="#" class="btn btn-action-button btn-icon btn-circle btn-sm confirm-delete" data-href="{{route('tax.destroy', $tax->id)}}" title="{{ translate('Delete') }}">
    ...
    <script type="text/javascript">
        ...
        function update_tax_status(el){
            ...
            $.post('{{ route('taxes.tax-status') }}', {_token:'{{ csrf_token() }}', id:el.value, status:status}, function(data){
                if(data == 1){
                    PLX.plugins.notify('success', '{{ translate('Tax status updated successfully') }}');
                }
                else{
