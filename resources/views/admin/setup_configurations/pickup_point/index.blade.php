...
<div class="plx-titlebar text-left mt-2">
	<div class="row align-items-center">
		...
		<div class="col-md-6 text-md-right">
			<a href="{{ route('pick_up_points.create') }}" class="btn btn-create">
...
<div class="card">
	<div class="card-header row gutters-5">
		<div class="col text-center text-md-left">
			<h5 class="mb-md-0 h6">{{ translate('All Pick-up Points') }}</h5>
		</div>
		<div class="col-md-4">
            ...
            <tbody>
                @foreach($pickup_points as $key => $pickup_point)
                    <tr>
						...
						<td class="text-right">
							<a class="btn btn-action-button btn-icon btn-sm" href="{{route('pick_up_points.edit', ['id'=>$pickup_point->id, 'lang'=>env('DEFAULT_LANGUAGE')] )}}" title="{{ translate('Edit') }}">
								<i class="las la-edit"></i>
							</a>
							<a href="#" class="btn btn-action-button btn-icon btn-sm confirm-delete" data-href="{{route('pick_up_points.destroy', $pickup_point->id)}}" title="{{ translate('Delete') }}">
