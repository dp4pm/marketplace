...
@section('content')
    ...
    @if(false)
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-header">
                        <h5 class="section-title mb-0 text-center">{{translate('HTTPS Activation')}}</h5>
                    </div>
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-header">
                        <h3 class="section-title mb-0 text-center">{{translate('Maintenance Mode Activation')}}</h3>
                    </div>
                    <div class="card-body text-center">
                        <label class="plx-switch plx-switch-success mb-0">
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-header">
                        <h3 class="section-title mb-0 text-center">{{translate('Disable image encoding?')}}</h3>
                    </div>
                    <div class="card-body text-center">
                        <label class="plx-switch plx-switch-success mb-0">
    ...
    @if(false)
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-header">
                        <h3 class="section-title mb-0 text-center">{{translate('Vendor System Activation')}}</h3>
                    </div>
                    <div class="card-body text-center">
                        <label class="plx-switch plx-switch-success mb-0">
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-header">
                        <h3 class="section-title mb-0 text-center">{{translate('Classified Product')}}</h3>
                    </div>
                    <div class="card-body text-center">
                        <label class="plx-switch plx-switch-success mb-0">
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-header">
                        <h3 class="section-title mb-0 text-center">{{translate('Wallet System Activation')}}</h3>
                    </div>
                    <div class="card-body text-center">
                        <label class="plx-switch plx-switch-success mb-0">
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-header">
                        <h3 class="section-title mb-0 text-center">{{translate('Coupon System Activation')}}</h3>
                    </div>
                    <div class="card-body text-center">
                        <label class="plx-switch plx-switch-success mb-0">
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-header">
                        <h3 class="section-title mb-0 text-center">{{translate('Pickup Point Activation')}}</h3>
                    </div>
                    <div class="card-body text-center">
                        <label class="plx-switch plx-switch-success mb-0">
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-header">
                        <h3 class="section-title mb-0 text-center">{{translate('Conversation Activation')}}</h3>
                    </div>
                    <div class="card-body text-center">
                        <label class="plx-switch plx-switch-success mb-0">
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-header">
                        <h3 class="section-title mb-0 text-center">{{translate('Seller Product Manage By Admin')}}</h3>
                    </div>
                    <div class="card-body text-center">
                        <label class="plx-switch plx-switch-success mb-0">
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-header">
                        <h3 class="section-title mb-0 text-center">{{translate('Admin Approval On Seller Product')}}</h3>
                    </div>
                    <div class="card-body text-center">
                        <label class="plx-switch plx-switch-success mb-0">
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-header">
                        <h3 class="section-title mb-0 text-center">{{translate('Email Verification')}}</h3>
                    </div>
                    <div class="card-body text-center">
                        <label class="plx-switch plx-switch-success mb-0">
    ...
    <h1 class="text-left mt-4 h3">{{translate('Payment Related')}}</h1>
    <br>
    <div class="row">
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-header text-center bord-btm">
                        <h3 class="section-title mb-0 text-center">{{translate('Paypal Payment Activation')}}</h3>
                    </div>
                    <div class="card-body">
                        <div class="clearfix">
                            <img class="float-left" src="{{ static_asset('assets/img/cards/paypal.png') }}" height="30">
                            <label class="plx-switch plx-switch-success mb-0 float-right">
        ...
        @if(false)
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-header">
                        <h3 class="section-title mb-0 text-center">{{translate('Stripe Payment Activation')}}</h3>
                    </div>
                    <div class="card-body text-center">
                        <div class="clearfix">
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-header">
                    <h3 class="section-title mb-0 text-center">{{translate('SSlCommerz Activation')}}</h3>
                </div>
                <div class="card-body text-center">
                    <div class="clearfix">
                    ...
                    <div class="alert color-base bg-base border-primary mt-2 mb-0">
    ...
    @if(false)
        <div class="row">
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-header">
                        <h3 class="section-title mb-0 text-center">{{translate('Instamojo Payment Activation')}}</h3>
                    </div>
                    <div class="card-body text-center">
                        <div class="clearfix">
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-header">
                        <h3 class="section-title mb-0 text-center">{{translate('Razor Pay Activation')}}</h3>
                    </div>
                    <div class="card-body text-center">
                        <div class="clearfix">
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-header">
                        <h3 class="section-title mb-0 text-center">{{translate('PayStack Activation')}}</h3>
                    </div>
                    <div class="card-body text-center">
                        <div class="clearfix">
    ...
    <div class="row">
        ...
        @if(false)
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-header">
                        <h3 class="section-title mb-0 text-center">{{translate('VoguePay Activation')}}</h3>
                    </div>
                    <div class="card-body text-center">
                        <div class="clearfix">
        ...
        @if(false)
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-header">
                        <h3 class="section-title mb-0 text-center">{{translate('Payhere Activation')}}</h3>
                    </div>
                    <div class="card-body text-center">
                        <div class="clearfix">
        ...
        @if(false)
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-header">
                        <h3 class="section-title mb-0 text-center">{{translate('Ngenius Activation')}}</h3>
                    </div>
                    <div class="card-body text-center">
                        <div class="clearfix">
        ...
        @if(false)
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-header">
                        <h3 class="section-title mb-0 text-center">{{translate('Iyzico Activation')}}</h3>
                    </div>
                    <div class="card-body text-center">
                        <div class="clearfix">
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-header">
                    <h3 class="section-title mb-0 text-center">{{translate('Bkash Activation')}}</h3>
                </div>
                <div class="card-body text-center">
                    <div class="clearfix">
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-header">
                    <h3 class="section-title mb-0 text-center">{{translate('Nagad Activation')}}</h3>
                </div>
                <div class="card-body text-center">
                    <div class="clearfix">
        ...
        @if(false)
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-header">
                        <h3 class="section-title mb-0 text-center">{{translate('Proxy Pay Activation')}}</h3>
                    </div>
                    <div class="card-body text-center">
                        <div class="clearfix">
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-header">
                    <h3 class="section-title mb-0 text-center">{{translate('Amarpay Activation')}}</h3>
                </div>
                <div class="card-body text-center">
                    <div class="clearfix">
        ...
        @if(false)
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-header">
                        <h3 class="section-title mb-0 text-center">{{translate('Authorize Net Activation')}}</h3>
                    </div>
                    <div class="card-body text-center">
                        <div class="clearfix">
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-header">
                    <h3 class="section-title mb-0 text-center">{{translate('Cash Payment Activation')}}</h3>
                </div>
                <div class="card-body text-center">
                    <div class="clearfix">
    ...
    <h1 class="text-left h3 mt-4">{{translate('Social Media Login')}}</h1>
    <br>
    <div class="row">
        <div class="col-lg-4">
            <div class="card">
                <div class="card-header">
                    <h3 class="section-title mb-0 text-center">{{translate('Facebook login')}}</h3>
                </div>
                <div class="card-body text-center">
                    <label class="plx-switch plx-switch-success mb-0">
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-header">
                    <h3 class="section-title mb-0 text-center">{{translate('Google login')}}</h3>
                </div>
                <div class="card-body text-center">
                    <label class="plx-switch plx-switch-success mb-0">
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-header">
                    <h3 class="section-title mb-0 text-center">{{translate('Twitter login')}}</h3>
                </div>
                <div class="card-body text-center">
                    <label class="plx-switch plx-switch-success mb-0">
    ...
    <script type="text/javascript">
        function updateSettings(el, type) {
            ...
            $.post('{{ route('business_settings.update.activation') }}', {_token: '{{ csrf_token() }}', type: type, value: value}, function (data) {
                if (data == '1') {
                    PLX.plugins.notify('success', '{{ translate('Settings updated successfully') }}');
                } else {
                    PLX.plugins.notify('danger', 'Something went wrong');
                }
            });
        }
    </script>
