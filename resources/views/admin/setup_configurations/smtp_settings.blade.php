...
<div class="row">
    <div class="col-md-6">
        <div class="card h-100">
            <div class="card-header">
                <h5 class="section-title mb-0">{{translate('SMTP Settings')}}</h5>
            </div>
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('env_key_update.update') }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <select class="form-control plx-selectpicker mb-2 mb-md-0" name="MAIL_DRIVER" onchange="checkMailDriver()">
    ...
    <div class="col-md-6">
        <div class="card h-100">
            <div class="card-header">
                <h5 class="section-title mb-0">{{translate('Instruction')}}</h5>
            </div>
            <div class="card-body">
    ...
    <div class="col-md-12 mt-3">
        <div class="card h-100">
            <div class="card-header">
                <h5 class="section-title mb-0">{{translate('Test SMTP configuration')}}</h5>
            </div>
            <div class="card-body">
