                        ...
                        <div class="sticky-top z-3 row gutters-10 flex-row-reverse">
                            @if($detailedProduct->photos != null)
                                ...
                                <div class="col-auto w-90px">
                                    <div class="plx-carousel carousel-thumb product-gallery-thumb" data-items='5' data-nav-for='.product-gallery' data-vertical='true' data-focus-select='true'>
                                        @foreach ($photos as $key => $photo)
            ...
            <div class="row">
                ...
                <div class="col-xl-9">
                    ...
                    <div class="bg-white rounded shadow-sm">
                        ...
                        <div class="p-3">
                            <div class="plx-carousel gutters-5 half-outside-arrow" data-items="5" data-xl-items="3" data-lg-items="4"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-arrows='true' data-infinite='true'>
