    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-8 mx-auto">
                <div class="row plx-steps arrow-divider">
                    <div class="col done">
    ...
    <script type="text/javascript">
        ...
        function use_wallet(){
            ...
            if($('#agree_checkbox').is(":checked")){
                ...
                PLX.plugins.notify('danger','{{ translate('You need to agree with our policies') }}');
            }
        }
        ...
        $(document).on("click", "#coupon-apply",function() {
            ...
            $.ajax({
                ...
                success: function (data, textStatus, jqXHR) {
                    PLX.plugins.notify(data.response_message.response, data.response_message.message);
