                ...
                <div class="modal-body">
                    <div class="p-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="mb-3">
                                    <select class="form-control plx-selectpicker" data-live-search="true" data-placeholder="{{ translate('Select your country') }}" name="country_id" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <select class="form-control mb-3 plx-selectpicker" data-live-search="true" name="state_id" required>
