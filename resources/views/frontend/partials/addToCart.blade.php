                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="col-10">
                                <div class="product-quantity d-flex align-items-center">
                                    <div class="row no-gutters align-items-center plx-plus-minus mr-3" style="width: 130px;">
                ...
                <div class="mt-3">
                    ...
                    @elseif($qty > 0)
                        @if ($product->external_link != null)
                            <a type="button" class="btn btn-action-button mr-2 add-to-cart fw-600" href="{{ $product->external_link }}">
