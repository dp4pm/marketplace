...
@section('panel_content')
    ...
    <div class="row align-items-center">
      <div class="col-md-6">
          <h1 class="h4">{{ translate('My Wallet') }}</h1>
      </div>
    </div>
    </div>
    ...
    <div class="card">
        <div class="card-header py-0">
            <div class="section-title border-bottom border-primary border-width-2 py-4 d-inline-block w-auto">{{translate('Wallet recharge history')}}</div>
        </div>
        <div class="card-body">
