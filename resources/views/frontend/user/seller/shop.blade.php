...
@section('panel_content')
    ...
    <div class="plx-titlebar mt-2 mb-2">
    ...
    {{-- Basic Info --}}
    <div class="card global-section-area-bottom-25">
        <div class="card-header border-bottom py-0">
            <div class="section-title border-bottom border-primary border-width-2 py-4">{{ translate('Basic Info') }}</div>
        </div>
        <div class="card-body">
    ...
    <div class="card global-section-area-bottom-25">
        <div class="card-header border-bottom py-0">
            <div class="section-title border-bottom border-primary border-width-2 py-4">{{ translate('Banner Settings') }}</div>
        </div>
        <div class="card-body">
            <form class="" action="{{ route('shops.update', $shop->id) }}" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="_method" value="PATCH">
    ...
    <div class="card">
        <div class="card-header border-bottom py-0">
            <div class="section-title border-bottom border-primary border-width-2 py-4">{{ translate('Social Media Link') }}</div>
        </div>
        <div class="card-body">
            <form class="" action="{{ route('shops.update', $shop->id) }}" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="_method" value="PATCH">
