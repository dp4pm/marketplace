...
<div class="plx-titlebar text-left mb-3">
	<div class="row align-items-center">
		<div class="col-md-6">
			<div class="section-title fw-600">{{translate('All uploaded files')}}</div>
		</div>
...
<div class="card">
    <form id="sort_uploads" action="">
        <div class="card-header row gutters-5 py-0">
            <div class="col-md-3">
                <div class="section-title border-bottom border-primary border-width-2 mb-0 py-4 d-inline-block w-auto">{{translate('All files')}}</div>
            </div>
            <div class="col-md-3 ml-auto mr-0">
                <select class="form-control form-control-xs plx-selectpicker" name="sort" onchange="sort_uploads()">
    		...
    		@foreach($all_uploads as $key => $file)
    			...
    			<div class="col-auto w-140px w-lg-220px">
    				<div class="plx-file-box">
    					...
    					<div class="card card-file plx-uploader-select c-default" title="{{ $file_name }}.{{ $file->extension }}">
...
<div id="info-modal" class="modal fade">
	<div class="modal-dialog modal-dialog-right">
			<div class="modal-content">
			<div class="modal-header">
				<h5 class="section-title fw-600">{{ translate('File Info') }}</h5>
...
@section('script')
	<script type="text/javascript">
		function detailsInfo(e){
			...
			$.post('{{ route('my_uploads.info') }}', {_token: PLX.data.csrf, id:id}, function(data){
