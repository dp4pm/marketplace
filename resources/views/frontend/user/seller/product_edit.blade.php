                        ...
                        <div class="col-lg-8">
                            <select class="form-control plx-selectpicker" name="video_provider" id="video_provider">
                                <option value="youtube"
                                    <?php if($product->video_provider == 'youtube') echo "selected";?>>
                ...
                <div class="card-body">
                    ...
                    <div class="customer_choice_options" id="customer_choice_options">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <select class="form-control plx-selectpicker attribute_choice" data-live-search="true"
                                    name="choice_options_{{ $choice_option->attribute_id }}[]" multiple>
                                    @foreach (\App\Models\AttributeValue::where('attribute_id',
                                    $choice_option->attribute_id)->get() as $row)
                                    <option value="{{ $row->value }}" @if( in_array($row->value,
                                        $choice_option->values)) selected @endif>
                                        {{ $row->value }}
                                    </option>
                                    @endforeach
                                </select>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control plx-date-range"
                        ...
                        <div class="col-lg-3">
                            <select class="form-control plx-selectpicker" name="discount_type" required>
                                ...
                                <option value="percent"
                                    <?php if($product->discount_type == 'percent') echo "selected";?>>
            ...
            <div class="card">
                ...
                <div class="card-body collapse show" id="collapse_2">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <label class="plx-switch plx-switch-success mb-0">
                                <input type="radio" name="shipping_type" value="free" @if($product->shipping_type ==
                                'free')
                                checked @endif>
                                <span></span>
                            </label>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                <div class="form-group row">\
                    ...
                    <div class="col-md-8">\
                        <select class="form-control plx-selectpicker attribute_choice" data-live-search="true" name="choice_options_' +
                    i + '[]" multiple>\
                            ' + obj + '\
                        </select>\
                    </div>\
