...
@section('panel_content')
    ...
    <form class="" action="{{route('digitalproducts.update', $product->id)}}" method="POST" enctype="multipart/form-data" id="choice_form">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group row" id="category">
                    ...
                    <div class="col-lg-9">
                        <select class="form-control plx-selectpicker" name="category_id" id="category_id" data-selected={{ $product->category_id }} required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control plx-tag-input" name="tags[]" id="tags" value="{{ $product->tags }}" placeholder="{{ translate('Type to add a tag') }}">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-3">
                        <select class="form-control plx-selectpicker" name="tax_type" required>
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="section-title mb-0">{{translate('Description')}}</h5>
            </div>
            <div class="card-body">
                <div class="form-group row">
                    <label class="col-lg-3 col-from-label">{{translate('Description')}}</label>
