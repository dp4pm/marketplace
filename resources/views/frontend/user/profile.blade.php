        ...
        @if(Auth::user()->seller)
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <label class="plx-switch plx-switch-success mb-3">
    ...
    <script type="text/javascript">
        ...
        $('.new-email-verification').on('click', function() {
            ...
            $.post('{{ route('user.new.verify') }}', {_token:'{{ csrf_token() }}', email: email}, function(data){
                ...
                if(data.status == 2)
                    PLX.plugins.notify('warning', data.message);
                else if(data.status == 1)
                    PLX.plugins.notify('success', data.message);
                else
                    PLX.plugins.notify('danger', data.message);
            });
        });
    </script>
