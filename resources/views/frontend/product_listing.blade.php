    ...
    <section class="mb-4 pt-3">
        <div class="container sm-px-0">
            <form class="" id="search-form" action="" method="GET">
                <div class="row">
                    <div class="col-xl-3">
                        <div class="plx-filter-sidebar collapse-sidebar-wrap sidebar-xl sidebar-right z-1035">
                            <div class="overlay overlay-fixed dark c-pointer" data-toggle="class-toggle" data-target=".plx-filter-sidebar" data-same=".filter-sidebar-thumb"></div>
                            <div class="collapse-sidebar c-scrollbar-light text-left">
                                <div class="d-flex d-xl-none justify-content-between align-items-center pl-3 border-bottom">
                                    <h3 class="h6 mb-0 fw-600">{{ translate('Filters') }}</h3>
                                    <button type="button" class="btn btn-sm p-2 filter-sidebar-thumb" data-toggle="class-toggle" data-target=".plx-filter-sidebar" >
                                        <i class="las la-times la-2x"></i>
                                    </button>
                                </div>
                                <div class="bg-white rounded mb-3">
                                    <div class="section-title fw-600 p-3 rounded bg-f4f4f4">
                                        ...
                                        <ul class="list-unstyled">
                                            @if (!isset($category_id))
                                                @foreach (\App\Models\Category::where('level', 0)->get() as $category)
                                                    <li class="mb-2 ml-2">
                                                        <a class="text-reset fs-16" href="{{ route('products.category', $category->slug) }}">{{ $category->getTranslation('name') }}</a>
                                                    </li>
                                                @endforeach
                                            @else
                                                <li class="mb-2">
                                                    <a class="text-reset fs-16 fw-600" href="{{ route('search') }}">
                                                ...
                                                @foreach (\App\Utility\CategoryUtility::get_immediate_children_ids($category_id) as $key => $id)
                                                    <li class="ml-5 mb-2">
                                                        <a class="text-reset fs-16" href="{{ route('products.category', \App\Models\Category::find($id)->slug) }}">{{ \App\Models\Category::find($id)->getTranslation('name') }}</a>
                                                    </li>
                                                @endforeach
                                            @endif
                                        </ul>
                                            ...
                                            <div class="plx-checkbox-list">
                                                @foreach ($attribute->attribute_values as $attribute_value)
                                                    <label class="plx-checkbox">
                                                        ...
                                                        <span class="fs-16">{{ $attribute_value->value }}</span>
                                                    </label>
                                                @endforeach
                                            </div>
                                        </div>
                                    ...
                                    <div class="bg-white rounded mb-3">
                                        ...
                                        <div class="p-3">
                                            <div class="plx-radio-inline">
                                                ...
                                                <label class="plx-megabox pl-0 mr-2" data-toggle="tooltip" data-title="{{ $color->name }}">
                                                    <input
                                                        type="radio"
                                                        name="color"
                                                        value="{{ $color->code }}"
                    ...
                    <div class="col-xl-9">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="form-group ml-auto mr-0 w-200px d-none d-xl-block">
                                    @if (Route::currentRouteName() != 'products.brand')
                                        ...
                                        <select class="form-control form-control-sm plx-selectpicker" data-live-search="true" name="brand" onchange="filter()">
                                ...
                                <div class="form-group w-200px ml-0 ml-xl-3">
                                    ...
                                    <select class="form-control form-control-sm plx-selectpicker" name="sort_by" onchange="filter()">
                                ...
                                <div class="d-xl-none ml-auto ml-xl-3 mr-0 form-group align-self-end">
                                    <button type="button" class="btn btn-icon p-0" data-toggle="class-toggle" data-target=".plx-filter-sidebar">
                        ...
                        <div class="plx-pagination plx-pagination-center mt-4">
