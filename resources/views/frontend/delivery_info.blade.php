                            ...
                            <div class="row border-top pt-3">
                                ...
                                <div class="col-md-6">
                                    <div class="row gutters-5">
                                        <div class="col-6">
                                            <label class="plx-megabox d-block bg-white mb-0">
                                                <input
                                                    type="radio"
                                                    ...
                                                    checked
                                                >
                                                <span class="d-flex p-3 plx-megabox-elem">
                                                    <span class="plx-rounded-check flex-shrink-0 mt-1"></span>
                                    ...
                                    <div class="mt-4 pickup_point_id_admin d-none">
                                        <select
                                            class="form-control plx-selectpicker"
