...
class OrderController extends Controller
{
    ...
    public function all_orders(Request $request)
    {
        ...
        $orders = $orders->paginate(15);
        return view('admin.sales.all_orders.index', compact('orders', 'sort_search', 'delivery_status', 'date'));
    }
    ...
    public function all_orders_show($id)
    {
        ...
        return view('admin.sales.all_orders.show', compact('order', 'delivery_boys'));
    }
