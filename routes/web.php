...
Route::post('/plx-uploader', 'PlxUploadController@show_uploader');
Route::post('/plx-uploader/upload', 'PlxUploadController@upload');
Route::get('/plx-uploader/get_uploaded_files', 'PlxUploadController@get_uploaded_files');
Route::post('/plx-uploader/get_file_by_ids', 'PlxUploadController@get_preview_files');
Route::get('/plx-uploader/download/{id}', 'PlxUploadController@attachment_download')->name('download_attachment');
...
Route::group(['prefix' => 'seller', 'middleware' => ['seller', 'verified', 'user']], function() {
    ...
    //Upload
    Route::any('/uploads/', 'PlxUploadController@index')->name('my_uploads.all');
    Route::any('/uploads/new', 'PlxUploadController@create')->name('my_uploads.new');
    Route::any('/uploads/file-info', 'PlxUploadController@file_info')->name('my_uploads.info');
    Route::get('/uploads/destroy/{id}', 'PlxUploadController@destroy')->name('my_uploads.destroy');
});
