...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    // uploaded files
    Route::any('/uploaded-files/file-info', 'PlxUploadController@file_info')->name('uploaded-files.info');
    Route::resource('/uploaded-files', 'PlxUploadController');
    Route::get('/uploaded-files/destroy/{id}', 'PlxUploadController@destroy')->name('uploaded-files.destroy');
